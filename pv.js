...
_uOsr[9]="netscape";	_uOkw[9]="query";
...
_uOsr[16]="yam";	_uOkw[16]="k";
_uOsr[17]="baidu";	_uOkw[17]="word";
_uOsr[18]="live";	_uOkw[18]="q";
_uOsr[19]="baidu";	_uOkw[19]="wd";
_uOsr[20]="yodao"; _uOkw[20]="q";
...
var wturl=document.URL;
if(wturl.length>8) {
 wturl=wturl.substring(7);
 var wtl=wturl.indexOf("/");
 if(wtl>0){wturl=wturl.substring(0,wtl);}
 var wts=wturl.split(".");
 var wtm=wts.length;
 if(wtm>1) {
  if(wts[wtm-2]=="windtear" && wts[wtm-1]=="net") {
   _uacct = "UA-259997-1";
   _udn=wts[wtm-2]+"."+wts[wtm-1];
  } else if(wts[wtm-2]=="ipcn" && wts[wtm-1]=="org") {
   _uacct = "UA-259997-2";
   _udn=wts[wtm-2]+"."+wts[wtm-1];
  } else if(wts[wtm-2]=="newsmth" && wts[wtm-1]=="net") {
   _uacct = "UA-259997-3";
   _udn=wts[wtm-2]+"."+wts[wtm-1];
  } else if(wts[wtm-2]=="windtear" && wts[wtm-1]=="com") {
   _uacct = "UA-259997-4";
   _udn=wts[wtm-2]+"."+wts[wtm-1];
  } else if(wts[wtm-2]=="ourantivirus" && wts[wtm-1]=="com") {
   _uacct = "UA-259997-5";
   _udn=wts[wtm-2]+"."+wts[wtm-1];
  } else {
   _uacct = "UA-259997-2";
